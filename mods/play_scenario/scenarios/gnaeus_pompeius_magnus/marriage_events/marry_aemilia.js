{
  ...
  checkAndAct(characterId) {
    ...
    if (character.flagPlayScenarioModIsPompey && !daapi.getCharacterFlag({ characterId: characterId, flag: 'pompey_engagement_2_over' })) {
      ...
      if (age > 20.6 && age < 21.6 &&
        ...
        if (potentialSpouse) {
            ...
            options: [
              {
                ...
                disabled: false,
                action: {
                  event: '/play_scenario/scenarios/gnaeus_pompeius_magnus/marriage_events/marry_aemilia',
                  method: 'wedding',
          ...
          daapi.setCharacterFlag({ characterId: characterId, flag: 'pompey_engagement_2_over', data: true })
