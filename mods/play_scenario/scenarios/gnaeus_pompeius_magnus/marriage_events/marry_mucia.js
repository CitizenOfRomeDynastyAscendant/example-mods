{
  ...
  checkAndAct(characterId) {
    ...
    if (character.flagPlayScenarioModIsPompey && !daapi.getCharacterFlag({ characterId: characterId, flag: 'pompey_engagement_3_over' })) {
        ...
        if (potentialSpouse) {
          ...
          daapi.pushInteractionModalQueue({
            ...
            message: `[c|${characterId}|${"Gnaeus Pompeius Magnus"}]` + ', Publius Antistius offers his daughter '
              + `[c|${potentialSpouse.id}|${"Antistia"}]` + '\'s MUCIA hand in marriage. '
            ...
            options: [
              {
                ...
                disabled: false,
                action: {
                  event: '/play_scenario/scenarios/gnaeus_pompeius_magnus/marriage_events/marry_mucia',
                  method: 'wedding',
          ...
          daapi.setCharacterFlag({ characterId: characterId, flag: 'pompey_engagement_3_over', data: true })
